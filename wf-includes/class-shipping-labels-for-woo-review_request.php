...
class Wf_WooCommerce_Packing_List_Woo_Review_Request
{
	/**
	* config options 
	*/
	private $plugin_title="WooCommerce Shipping Label";
	private $review_url="https://wordpress.org/support/plugin/shipping-labels-for-woo/reviews/#new-post";
	private $plugin_prefix="wt_pkl_sh"; /* must be unique name */
	private $activation_hook="wt_pkl_sh_activate"; /* hook for activation, to store activated date */
	private $deactivation_hook="wt_pkl_sh_deactivate"; /* hook for deactivation, to delete activated date */
	private $days_to_show_banner=10; /* when did the banner to show */
	private $remind_days=15; /* remind interval in days */
	private $webtoffee_logo_url=WT_PKL_SH_PLUGIN_URL.'assets/images/webtoffee-logo_small.png';
	...
	public function __construct()
	{
		...
		{
			$this->banner_message=sprintf(__("Hey, we at %sWebToffee%s would like to thank you for using %s %s %s. %s Less than a minute of your time will motivate us to keep doing what we do. We would really appreciate if you could take a moment to drop a quick review that motivate us to keep going.", 'wf-woocommerce-packing-list'), '<b>', '</b>','<b>', $this->plugin_title, '</b>', '<br />');
...
new Wf_WooCommerce_Packing_List_Woo_Review_Request();